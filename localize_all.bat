...
itemdb_localizer.rb --nobackup %rAthena_PATH%\db\re\item_db_equip_jpn.yml %Auriga_PATH%\db\item_db.txt
itemdb_localizer.rb --nobackup %rAthena_PATH%\db\re\item_db_etc_jpn.yml %Auriga_PATH%\db\item_db.txt
itemdb_localizer.rb --nobackup %rAthena_PATH%\db\re\item_db_usable_jpn.yml %Auriga_PATH%\db\item_db.txt
